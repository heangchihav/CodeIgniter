...
<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    <div class="mb-6">
        ...
        <p class="text-gray-600">Create a new payment option for customers</p>
    </div>
    ...
    <div class="bg-white shadow-sm border border-gray-200 rounded-lg overflow-hidden">
        <form action="<?= base_url('/admin/payment-methods/store') ?>" method="post" class="p-6">
            <?= csrf_field() ?>
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <textarea name="instructions" rows="4" 
                              class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                              placeholder="Provide detailed instructions for customers on how to complete the payment..."><?= old('instructions') ?></textarea>
